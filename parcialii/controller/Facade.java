...
import parcialii.model.ILogin;
import parcialii.model.SystemRemoteException;
import parcialii.model.User;
import parcialii.model.composite.Zona;
import parcialii.model.decorator.Bus;
import parcialii.model.decorator.BusConductor;
import parcialii.model.decorator.BusRuta;
import parcialii.model.decorator.UnBus;
...
public class Facade implements ILogin {
    ...
    private String crearContenedor(String ciudad) {
        Proxy proxy = Proxy.getInstance();
        proxy.crearContenedor(ciudad);
        return "void"; // Tuve que volver el metodo a String y que devuelva un valor String "void"
    }
    ...
    private String crearUsuarioComposite(String documento) {
        ...
        zona.add(usuario); // Esto el GarbageColection lo borra... No hace nada
        return retorno;
    }
